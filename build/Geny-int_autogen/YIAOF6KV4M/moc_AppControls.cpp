...
struct qt_meta_stringdata_CLASSAppControlsENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAppControlsENDCLASS = QtMocHelpers::stringData(
    "AppControls",
    "error_occured",
    "",
    "ConfigBox*",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSAppControlsENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSAppControlsENDCLASS_t qt_meta_stringdata_CLASSAppControlsENDCLASS = {
    {
        QT_MOC_LITERAL(0, 11),  // "AppControls"
        QT_MOC_LITERAL(12, 13),  // "error_occured"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 10),  // "ConfigBox*"
        QT_MOC_LITERAL(38, 16),  // "no_error_occured"
        QT_MOC_LITERAL(55, 23),  // "on_generated_bt_clicked"
        QT_MOC_LITERAL(79, 10),  // "ResultBox*"
        QT_MOC_LITERAL(90, 16),  // "on_config_change"
        QT_MOC_LITERAL(107, 16),  // "on_error_occured"
        QT_MOC_LITERAL(124, 8),  // "conf_box"
        QT_MOC_LITERAL(133, 5),  // "error"
        QT_MOC_LITERAL(139, 19)   // "on_no_error_occured"
    },
    "AppControls",
    "error_occured",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAppControlsENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AppControls::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAppControlsENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAppControlsENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAppControlsENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void AppControls::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AppControls::*)(ConfigBox * , const QString & );
            if (_t _q_method = &AppControls::error_occured; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AppControls::*)(ConfigBox * );
            if (_t _q_method = &AppControls::no_error_occured; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *AppControls::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAppControlsENDCLASS.stringdata0))
